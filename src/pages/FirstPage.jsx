  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", minHeight: "80vh", padding: "0 60px", position: "relative" }}>
      <div style={{ flex: 1, textAlign: "left" }}>
        ...
        <button onClick={() => navigate("/page2")} style={{ padding: "12px 25px", fontSize: "16px", fontWeight: "bold", background: "#FF6633", color: "#fff", border: "none", borderRadius: "25px", cursor: "pointer", marginTop: "10px" }}>Get Started →</button>
      </div>
      <div style={{ position: "absolute", top: "50%", right: "0", width: "45%", maxHeight: "90%", display: "flex", alignItems: "center", justifyContent: "flex-end", overflow: "hidden", transform: "translateY(-50%)", marginRight: "-40px" }}>
        <img src={firstImage} alt="Life Insurance" style={{ maxWidth: "100%", height: "auto", display: "block", objectFit: "contain" }} />
      </div>
    </div>
  );
}